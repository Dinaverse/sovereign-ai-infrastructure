...
1: lo: <LOOPBACK,UP,LOWER_UP> mtu 65536 qdisc noqueue state UNKNOWN group default qlen 1000
    inet <INTERNAL_IP>/8 scope host lo
2: eth0: <BROADCAST,MULTICAST,UP,LOWER_UP> mtu 1500 qdisc fq_codel state UP group default qlen 1000
    inet <KALI_IP>/24 brd <INTERNAL_IP> scope global dynamic noprefixroute eth0
11: wlan0: <BROADCAST,MULTICAST,UP,LOWER_UP> mtu 1500 qdisc noqueue state UP group default qlen 1000
    inet <GATEWAY_IP>/24 brd <INTERNAL_IP> scope global noprefixroute wlan0
...
11: wlan2: <BROADCAST,MULTICAST,UP,LOWER_UP> mtu 1500 qdisc noqueue state UP group default qlen 1000
    inet <EXTERNAL_NETWORK_IP_1>/24 brd <INTERNAL_IP> scope global wlan2
    inet <ARCH_CLUSTER_IP>/24 brd <INTERNAL_IP> scope global noprefixroute wlan2
...
3: wlan0: <BROADCAST,MULTICAST,UP,LOWER_UP> mtu 1500 qdisc fq_codel state UP group default qlen 1000
    inet <EXTERNAL_NETWORK_IP_2>/24 brd <INTERNAL_IP> scope global dynamic noprefixroute wlan0
4: wlan1: <BROADCAST,MULTICAST,UP,LOWER_UP> mtu 1500 qdisc noqueue state UP group default qlen 1000
    inet <RASPBERRY_PI_IP>/24 brd <INTERNAL_IP> scope global dynamic noprefixroute wlan1
...
3: wlx00a1b0501d50: <BROADCAST,MULTICAST,UP,LOWER_UP> mtu 1500 qdisc mq state UP group default qlen 1000
    inet <CANWORK_IP>/24 brd <INTERNAL_IP> scope global dynamic noprefixroute wlx00a1b0501d50

## Host: Dell Precision (<DELL_PRECISION_IP>)
### System Status
Linux DESKTOP-JGPTREA <INTERNAL_IP>-microsoft-standard-WSL2 #1 SMP PREEMPT_DYNAMIC Mon Dec  1 20:46:23 UTC 2025 x86_64 x86_64 x86_64 GNU/Linux
...
2: eth0: <BROADCAST,MULTICAST,UP,LOWER_UP> mtu 1500 qdisc mq state UP group default qlen 1000
    inet <INTERNAL_IP>/20 brd <INTERNAL_IP> scope global eth0
